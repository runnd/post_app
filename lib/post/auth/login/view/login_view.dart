...
class LoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF4A90E2), // Updated color scheme
        centerTitle: true,
        title: Text(
          "Post App", // Updated app name
          style: TextStyle(
            color: Colors.white,
            fontSize: 24,
            ...
            children: [
              ...
              Align(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    "Forgot Password?",
                    style: TextStyle(color: Color(0xFF4A90E2)), // Updated color
                  ),
                ),
              ),
              SizedBox(height: 30),
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color(0xFF4A90E2), // Updated color
